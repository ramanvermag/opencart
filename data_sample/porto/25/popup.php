...
$output["popup_module"] = array (
  ...
  array (
    ...
    array (
      $language_id => '<img src="http://www.newsmartwave.net/magento/porto/skin/frontend/smartwave/porto/images/logo_charcoal.png" alt="">
 <h2>BE THE FIRST TO KNOW</h2>
<p>Subscribe to the Porto eCommerce newsletter to receive timely updates from your favorite products.</p>  
',
      1 => '<img src="http://www.newsmartwave.net/magento/porto/skin/frontend/smartwave/porto/images/logo_charcoal.png" alt="">
 <h2>BE THE FIRST TO KNOW</h2>
<p>Subscribe to the Porto eCommerce newsletter to receive timely updates from your favorite products.</p>  
',
    ),
